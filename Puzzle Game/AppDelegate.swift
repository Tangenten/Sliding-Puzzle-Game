...
class AppDelegate: UIResponder, UIApplicationDelegate, UNUserNotificationCenterDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        Music.instance.playMusic(name: String(theFileName.dropLast(4)))
        Music.instance.updateMusic()
        
        var notif = PushNotification(title: "Welcome", body: "Thanks for playing")
        notif.playNotification()
        
        let userDefaultsDefaults = [
            "musicVolume" : 0.75,
            "soundVolume" : 1,
            "musicMuteState" : false,
            "soundMuteState" : false
            ]  as [String: Any]
